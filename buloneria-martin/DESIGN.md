---
name: "buloneria martin"
description: "Tienda / E-commerce — Todo para tu Casa"
version: alpha
colors:
  primary: "#1e40af"
  secondary: "#3b82f6"
...
## Overview
A single-page tienda / e-commerce website in the profesional style. Tagline: "Todo para tu Casa". Clean, balanced, and trustworthy. Structured layouts with generous whitespace. Typography is clear and authoritative. Subtle shadows and borders define hierarchy.
