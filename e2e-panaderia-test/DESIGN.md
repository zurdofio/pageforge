---
name: "E2E Panaderia Test"
description: "Restaurante / Gastronomía — Pan de masa madre todos los dias"
version: alpha
colors:
  primary: "#78350f"
  secondary: "#f59e0b"
...
## Overview
A single-page restaurante / gastronomía website in the profesional style. Tagline: "Pan de masa madre todos los dias". Clean, balanced, and trustworthy. Structured layouts with generous whitespace. Typography is clear and authoritative. Subtle shadows and borders define hierarchy.
