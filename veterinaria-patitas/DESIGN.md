...
description: "Salud y bienestar — Cuidamos a tu mascota como parte de la familia"
version: alpha
colors:
  primary: "#166534"
  secondary: "#22c55e"
...
## Overview
A single-page salud y bienestar website in the profesional style. Tagline: "Cuidamos a tu mascota como parte de la familia". Clean, balanced, and trustworthy. Structured layouts with generous whitespace. Typography is clear and authoritative. Subtle shadows and borders define hierarchy.
