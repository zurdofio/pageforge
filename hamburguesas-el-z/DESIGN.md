# DESIGN.md — hamburguesas el Z

## 1. Overview & Creative Direction

**Business:** hamburguesas el Z
**Industry:** Restaurante / Gastronomía
**Tagline:** las mejores hamburguesas de san roque
...
| Role | Color | Usage |
|------|-------|-------|
| Primary | #991b1b | Headers, primary buttons, key UI elements |
| Secondary | #ef4444 | Supporting elements, hover states, secondary buttons |
| Accent | #fca5a5 | Highlights, links, call-to-action accents |
